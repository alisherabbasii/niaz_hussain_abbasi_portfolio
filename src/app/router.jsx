...
// Content-drafting tool, gated by a real backend session (see
// src/features/admin/AuthContext.jsx) — reachable on the live site by URL,
// but never linked from navigation and marked noindex (Admin.jsx) so it
// doesn't surface in search results.
